...
strong_rate = 0.07
oblique_rate = 0.02
font_dir = '/media/wn/DATA/OCR2021/SRNet/datasets/fonts/english_ttf/'
standard_font_path = '/media/wn/DATA/OCR2021/SRNet/datasets/fonts/english_ttf/arial.ttf'
...
# background
bg_filepath = '/media/wn/DATA/OCR2021/SRNet/datasets/imnames.cp'
temp_bg_path = '/media/wn/DATA/OCR2021/SRNet/datasets/bg_data/bg_img/'
